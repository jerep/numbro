...
function a(a,b){this._value=a,this._currencyCode=b}function b(a){return 0===a?1:Math.floor(Math.log(Math.abs(a))/Math.LN10)+1}function c(a){var b,c="";for(b=0;a>b;b++)c+="0";return c}/**
...
a._value=i?Math.ceil(a._value):a._value)}return a._value}function h(a,b,c,d){var e,f,g=c,h=g.indexOf("$"),i=g.indexOf("("),j=g.indexOf("+"),k=g.indexOf("-"),l="",m="",o=z[B].currency;if(a._currencyCode&&a._currencyCode!==o.code&&z[B].foreignCurrencies){var p=z[B].foreignCurrencies[a._currencyCode];p&&(o=p)}if(-1===g.indexOf("$")?
// Use defaults instead of the format provided
"infix"===o.position?(m=o.symbol,o.spaceSeparated&&(m=" "+m+" ")):o.spaceSeparated&&(l=" "):g.indexOf(" $")>-1?(l=" ",g=g.replace(" $","")):g.indexOf("$ ")>-1?(l=" ",g=g.replace("$ ","")):g=g.replace("$",""),f=n(a._value,g,d,m),-1===c.indexOf("$"))
// Use defaults instead of the format provided
switch(o.position){case"postfix":f.indexOf(")")>-1?(f=f.split(""),f.splice(-1,0,l+o.symbol),f=f.join("")):f=f+l+o.symbol;break;case"infix":break;case"prefix":f.indexOf("(")>-1||f.indexOf("-")>-1?(f=f.split(""),e=Math.max(i,k)+1,f.splice(e,0,o.symbol+l),f=f.join("")):f=o.symbol+l+f;break;default:throw Error('Currency position should be among ["prefix", "infix", "postfix"]')}else
// position the symbol
1>=h?f.indexOf("(")>-1||f.indexOf("+")>-1||f.indexOf("-")>-1?(f=f.split(""),e=1,(i>h||j>h||k>h)&&(e=0),f.splice(e,0,o.symbol+l),f=f.join("")):f=o.symbol+l+f:f.indexOf(")")>-1?(f=f.split(""),f.splice(-1,0,l+o.symbol),f=f.join("")):f=f+l+o.symbol;return f}function i(a,b,c,d){return h(a,b,c,d)}function j(a,b,c){var d,e="",f=100*a._value;
